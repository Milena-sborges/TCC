...
--
-- Este arquivo foi utilizado durante o desenvolvimento
-- do banco de dados.
--
-- Os comandos foram sendo comentados conforme eram
-- executados para evitar execução duplicada.
-- =====================================================
